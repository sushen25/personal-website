...
class DynamoDBHelper:
    ...
    def get_item(self, key: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # Convert Decimal to float for JSON serialization (from agent-service implementation)
    ...
    def update_item(
        ...
        Args:
            ...
            expression_attribute_values: Attribute values dictionary
            expression_attribute_names: Optional attribute names dictionary
        ...
        try:
            update_params = {
                ...
                'ExpressionAttributeValues': self._convert_floats_to_decimal(expression_attribute_values)
            }
            ...
            print(f"Error updating item in {self.table_name}: {str(e)}")
            return False
    ...
    def batch_write(self, items: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            print(f"Error batch writing to {self.table_name}: {str(e)}")
            return False
